        ...
        for (var e = b.buildFunctionPattern(), a = !0, d = Array(b.TotalCodewords), h = 0, j = 0, k = 0, n = c - 1; 0 < n; n -= 2) {
            ...
            for (var l = 0; l < c; l++)
                for (var s = a ? c - 1 - l : l, r = 0; 2 > r; r++)
                    e.get_Renamed(n - r, s) || (k++, j <<= 1, this.bitMatrix.get_Renamed(n - r, s) && (j |= 1), 8 == k && (d[h++] = j, j = k = 0));
            a ^= 1
        }
...
function FinderPatternFinder() {
    ...
    this.haveMultiplyConfirmedCenters = function () {
        ...
        for (var d = a / c, g = 0, b = 0; b < c; b++)
            e = this.possibleCenters[b], g += Math.abs(e.EstimatedModuleSize - d);
        return g <= 0.05 * a
    };
                    ...
                    if (4 == h)
                        if (this.foundPatternCross(g)) {
                            if (h =
                                ...
                                b = 2, this.hasSkipped ? e = this.haveMultiplyConfirmedCenters() : (h = this.findRowSkip(), h > g[2] && (f += h - g[2] - b, j = c - 1));
                            else {
                                do
                                    j++;
                            ...
                            g[0] = g[2], g[1] = g[3], g[2] = g[4], g[3] = 1, g[4] = 0, h = 3;
                    else
                        g[++h]++;
                else
                    g[h]++;
...
function AlignmentPatternFinder(d, a, c, b, e, g, f) {
    ...
    this.find = function () {
        for (var a = this.startX, e = this.height, g = a + b, f = c + (e >> 1), l = [0, 0, 0], s = 0; s < e; s++) {
            ...
            for (var q = 0; m < g; ) {
                if (d[m + r * qrcode.width])
                    if (1 == q)
                        ...
                        if (this.foundPatternCross(l) && (q = this.handlePossibleCenter(l, r, m), null != q))
                            return q;
                        l[0] = l[2];
                        l[1] = 1;
                        l[2] = 0;
            ...
            if (this.foundPatternCross(l) && (q = this.handlePossibleCenter(l, r, g), null != q))
                return q
        }
...
function QRCodeDataBlockReader(d, a, c) {
    ...
    this.getFigureString = function (b) {
        var a = 0,
                c = "";
        do
            3 <= b ? (a = this.getNextBits(10), 100 > a && (c += "0"), 10 > a && (c += "0"), b -= 3) : 2 == b ? (a = this.getNextBits(7), 10 > a && (c += "0"), b -= 2) : 1 == b && (a = this.getNextBits(4), b -= 1), c += a;
        while (0 < b);
        return c
    };
...
(function (d) {
    ...
    d.fn.html5_qrcode = function (a, c, b) {
        ...
        qrcode.callback =
                a
//    },
//    d.fn.html5_qrcode_1 = function(a, c, b) {
//        console.log("hello from plugin");
    },
            d.fn.html5_qrcode_stop = function () {
                var h = d("#html5_qrcode_video").get(0),
                        j;
                d("#qr-canvas").each(function (a, b) {
                    j = b.getContext("2d")
